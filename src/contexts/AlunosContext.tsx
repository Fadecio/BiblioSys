...
export interface AlunosContextValor {
  alunos: Aluno[]
  carregando: boolean
  erro: string | null
...
// eslint-disable-next-line react-refresh/only-export-components -- Context precisa ser exportado junto do Provider pra useAlunos (hooks/useAlunos.tsx) consumi-lo
export const AlunosContext = createContext<AlunosContextValor | null>(null)
