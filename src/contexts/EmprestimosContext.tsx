...
export interface EmprestimosContextValor {
...
// eslint-disable-next-line react-refresh/only-export-components -- Context precisa ser exportado junto do Provider pra useEmprestimos (hooks/useEmprestimos.tsx) consumi-lo
export const EmprestimosContext = createContext<EmprestimosContextValor | null>(null)
