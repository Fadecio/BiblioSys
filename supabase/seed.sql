...
insert into public.books (id, title, isbn, publisher, publication_year, total_copies, available_copies, author_id, category_id) values
  ('b0000000-0000-0000-0000-000000000001', 'Dom Casmurro', '9788535910663', 'Companhia das Letras', 1899, 3, 3, 'a0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000002', 'Memórias Póstumas de Brás Cubas', '9788535910670', 'Companhia das Letras', 1881, 2, 2, 'a0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000003', 'Quincas Borba', '9788535910687', 'Companhia das Letras', 1891, 2, 2, 'a0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000004', 'O Pequeno Príncipe', '9788574065070', 'Agir', 1943, 4, 4, 'a0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002'),
  ('b0000000-0000-0000-0000-000000000005', 'Vidas Secas', '9788520925215', 'Record', 1938, 2, 2, 'a0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000006', 'São Bernardo', '9788520925222', 'Record', 1934, 2, 2, 'a0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000007', 'Capitães da Areia', '9788535914713', 'Companhia das Letras', 1937, 3, 3, 'a0000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000008', 'Gabriela, Cravo e Canela', '9788535914720', 'Companhia das Letras', 1958, 2, 2, 'a0000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000009', 'Iracema', '9788508162665', 'Ática', 1865, 2, 2, 'a0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000010', 'O Guarani', '9788508162672', 'Ática', 1857, 2, 2, 'a0000000-0000-0000-0000-000000000005', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000011', 'O Cortiço', '9788508162689', 'Ática', 1890, 2, 2, 'a0000000-0000-0000-0000-000000000006', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000012', 'Sítio do Picapau Amarelo', '9788525056101', 'Globo', 1920, 3, 3, 'a0000000-0000-0000-0000-000000000007', 'c0000000-0000-0000-0000-000000000002'),
  ('b0000000-0000-0000-0000-000000000013', 'Reinações de Narizinho', '9788525056118', 'Globo', 1931, 3, 3, 'a0000000-0000-0000-0000-000000000007', 'c0000000-0000-0000-0000-000000000002'),
  ('b0000000-0000-0000-0000-000000000014', 'A Moreninha', '9788508162696', 'Ática', 1844, 1, 1, 'a0000000-0000-0000-0000-000000000008', 'c0000000-0000-0000-0000-000000000001'),
  ('b0000000-0000-0000-0000-000000000015', 'Ou Isto ou Aquilo', '9788520006174', 'Nova Fronteira', 1964, 3, 3, 'a0000000-0000-0000-0000-000000000009', 'c0000000-0000-0000-0000-000000000004'),
  ('b0000000-0000-0000-0000-000000000016', 'O Menino Maluquinho', '9788532502279', 'Melhoramentos', 1980, 4, 4, 'a0000000-0000-0000-0000-000000000010', 'c0000000-0000-0000-0000-000000000008'),
  ('b0000000-0000-0000-0000-000000000017', 'Enciclopédia de Ciências Ilustrada', '9788572085001', 'Editora Ática', 2015, 2, 2, null, 'c0000000-0000-0000-0000-000000000006'),
  ('b0000000-0000-0000-0000-000000000018', 'Atlas Geográfico Escolar', '9788572085018', 'IBGE Educa', 2019, 2, 2, null, 'c0000000-0000-0000-0000-000000000003'),
  ('b0000000-0000-0000-0000-000000000019', 'História do Brasil para Jovens', '9788572085025', 'Moderna', 2018, 2, 2, null, 'c0000000-0000-0000-0000-000000000007'),
  ('b0000000-0000-0000-0000-000000000020', 'Contos Brasileiros Essenciais', '9788572085032', 'Moderna', 2012, 2, 2, null, 'c0000000-0000-0000-0000-000000000005')
on conflict (id) do nothing;

-- ── students (15) ─────────────────────────────────────────────────────────
insert into public.students (id, name, registration_number, class, active) values
  ('d0000000-0000-0000-0000-000000000001', 'Ana Beatriz Souza', '2026-0001', '5A', true),
  ('d0000000-0000-0000-0000-000000000002', 'Bruno Carvalho Lima', '2026-0002', '5A', true),
  ('d0000000-0000-0000-0000-000000000003', 'Carla Mendes Rocha', '2026-0003', '6B', true),
  ('d0000000-0000-0000-0000-000000000004', 'Diego Fernandes Alves', '2026-0004', '6B', true),
  ('d0000000-0000-0000-0000-000000000005', 'Elisa Ramos Teixeira', '2026-0005', '7A', true),
  ('d0000000-0000-0000-0000-000000000006', 'Felipe Nogueira Dias', '2026-0006', '7A', true),
  ('d0000000-0000-0000-0000-000000000007', 'Gabriela Pinto Duarte', '2026-0007', '8C', true),
  ('d0000000-0000-0000-0000-000000000008', 'Henrique Barbosa Cunha', '2026-0008', '8C', true),
  ('d0000000-0000-0000-0000-000000000009', 'Isabela Cardoso Martins', '2026-0009', '9A', true),
  ('d0000000-0000-0000-0000-000000000010', 'João Pedro Azevedo', '2026-0010', '9A', true),
  ('d0000000-0000-0000-0000-000000000011', 'Karina Souza Lopes', '2026-0011', '5B', true),
  ('d0000000-0000-0000-0000-000000000012', 'Lucas Martins Farias', '2026-0012', '6A', true),
  ('d0000000-0000-0000-0000-000000000013', 'Mariana Costa Ribeiro', '2026-0013', '7B', true),
  ('d0000000-0000-0000-0000-000000000014', 'Nícolas Almeida Silva', '2026-0014', '8A', true),
  ('d0000000-0000-0000-0000-000000000015', 'Olívia Torres Nunes', '2026-0015', '9B', false)
on conflict (id) do nothing;
